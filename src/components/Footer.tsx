    ...
    <footer className="bg-foreground text-background py-12 lg:py-16">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-display font-bold">NFS-e Médico</span>
            </div>
            <p className="text-background/70 mb-6 max-w-md">
              Sistema de emissão de Nota Fiscal Eletrônica desenvolvido 
              especialmente para profissionais de saúde. Conformidade total 
              com as exigências do GOV.BR.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-background/70">
              ...
              <li className="flex items-center gap-2">
                ...
                <span>contato@nfsemedico.com.br</span>
              </li>
        ...
        <div className="mt-12 pt-8 border-t border-background/10 text-center text-background/50 text-sm">
          <p>© 2026 NFS-e Médico. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  );
